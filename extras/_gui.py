...
from _4_query_handler import load_faiss_index, retrieve_top_k_chunks, generate_response, filter_relevant_chunks, load_combined_question_answer_texts
...
CONFIDENCE_THRESHOLD = 60  # Adjust this to fine-tune strictness
